...
import zeroshot.models.kgraphs
...
def main():
  ...
  _model = zeroshot.models.kgraphs.KnowledgeGraphModelHelper(config)
    
  _dataset_fn = zeroshot.datasets.prevideo.ZSLPrecompVideoLabelGraphDataset
  ...
  if opts.is_train:
    ...
    trn_dataset = _dataset_fn(data_cfg.name_files['trn'], data_cfg.label_embed_file, 
      data_cfg.meta_files['trn'], data_cfg.class_idxs_files['trn'], data_cfg.k_class_split,
      target_embed_file=data_cfg.target_embed_file, ft_dir=None, is_train=True, 
      graph_topk_neighbors=model_cfg.graph_topk_neighbors)
    val_dataset = _dataset_fn(data_cfg.name_files['val'], data_cfg.label_embed_file, 
      data_cfg.meta_files['val'], data_cfg.class_idxs_files['val'], data_cfg.k_class_split,
      graph_topk_neighbors=model_cfg.graph_topk_neighbors, ft_dir=data_cfg.ft_dir, is_train=False)
    ...
    tst_dataset = _dataset_fn(data_cfg.name_files[opts.eval_set], 
