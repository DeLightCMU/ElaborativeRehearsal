...
def main():
  ...
  val_dataset = _dataset_fn(data_cfg.name_files['val'], 
    data_cfg.label_embed_file, data_cfg.meta_files['val'], 
    data_cfg.class_idxs_files['val'], opts.k_class_split, ft_dir=data_cfg.ft_dir,
    graph_topk_neighbors=model_cfg.graph_topk_neighbors, is_train=False)
  ...
  tst_dataset = _dataset_fn(data_cfg.name_files['tst'],
    data_cfg.label_embed_file, data_cfg.meta_files['tst'],
    data_cfg.class_idxs_files['tst'], opts.k_class_split, ft_dir=data_cfg.ft_dir,
    graph_topk_neighbors=model_cfg.graph_topk_neighbors, is_train=False)
