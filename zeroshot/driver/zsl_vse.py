...
def main():
  ...
  parser.add_argument('--resume_file', default=None, nargs='+')
  ...
  if opts.is_train:
    ...
    trn_dataset = _dataset_fn(data_cfg.name_files['trn'], vis_data_dir,
      ...
      is_train=True, **vis_data_kwargs)
    val_dataset = _dataset_fn(data_cfg.name_files['val'], vis_data_dir,
      data_cfg.label_text_file, data_cfg.meta_files['val'], 
      data_cfg.class_idxs_files['val'], data_cfg.k_class_split,
      int2word_file=data_cfg.int2word_file, max_words_in_text=data_cfg.max_words_in_text, 
      _tokenizer=data_cfg.tokenizer, cat_word_with_defn=data_cfg.cat_word_with_defn,
      is_train=False, **vis_data_kwargs)
    ...
    tst_dataset = _dataset_fn(data_cfg.name_files[opts.eval_set], vis_data_dir,
